      ...
      <div className="w-full px-6 py-4 flex items-center justify-between relative">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex items-center">
          <Link to="/" className="flex items-center">
            <img src="/logo.png" alt="Astra Boutique" className="h-16" />
          </Link>
        </div>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="px-6 mt-10 pt-6 border-t border-gray-100">
              ...
              <div className="flex gap-3">
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-16 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary transition-all">
