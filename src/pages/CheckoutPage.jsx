      ...
      <div className="max-w-lg mx-auto px-6">
        ...
        <div className="bg-white p-6 border border-gray-200 mb-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg text-center mb-4">
            ...
            <p className="text-2xl font-menu font-bold">TU_NUMERO_NEQUI_AQUI</p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg text-center mb-4">
            <p className="text-xs font-menu text-gray-500 mb-1">Nombre</p>
            <p className="text-lg font-menu font-medium">TU_NOMBRE_AQUI</p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg text-center">
            <p className="text-xs font-menu text-gray-500 mb-1">Monto a pagar</p>
            <p className="text-xl font-menu font-bold text-[#251E1A]">${total.toLocaleString('es-CO')} COP</p>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-xs font-menu text-gray-400 mb-4">
            Envía el comprobante de pago por WhatsApp o al correo <strong>{formData.email}</strong> sera notificado con el estado de tu pedido.
          </p>
          <Link
            to="/"
            className="inline-block text-white py-3 px-8 text-sm font-menu hover:opacity-90 transition-all"
